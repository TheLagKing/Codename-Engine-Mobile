...
class ModsFolder {
	 ...
	 */
	public static var modsPath:String = #if mobile SUtil.getStorageDirectory() + "/mods/" #else "./mods/" #end;
	/**
	 * Path to the `addons` folder.
	 */
	public static var addonsPath:String = #if mobile SUtil.getStorageDirectory() + "/addons/" #else "./addons/" #end;
