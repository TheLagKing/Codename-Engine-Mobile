...
class HitBox extends FlxSpriteGroup
{
    ...
    function addButtons() {
        ...
        var offsetFir:Int = hasExtraButton ? Std.int(FlxG.height * 0.75) : 0;
        ...
        if (hasExtraButton) {
            add(buttonSpace = createHitbox(0, offsetFir, FlxG.width, Std.int(FlxG.height * 0.25), '0x7700FF', true));
        }
    }

    function createHitbox(x:Float, y:Float, width:Int, height:Int, color:String, ?isSpace:Bool = false)
    {
