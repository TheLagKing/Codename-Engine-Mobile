...
class HitBox extends FlxSpriteGroup
{
    ...
    function addButtons() {
        ...
        var buttonHeight:Int = hasExtraButton ? (Options.extrabuttontop ? Std.int(FlxG.height * 0.75 - 140) : Std.int(FlxG.height * 0.75)) : FlxG.height;
        var extraY:Int = hasExtraButton ? (Options.extrabuttontop ? Std.int(FlxG.height * 0.75 / 70) : Std.int(FlxG.height * 0.75)) : 0;
